...
export const PARTICLE_PRESETS = {
  ...
  chimney_smoke: { maxParticles: 36, spawnRate: 5, lifetime: [2.5, 6], speed: [4, 14], size: [14, 34], endSize: [42, 90], alpha: [0.05, 0.2], colors: ["#777777"], texture: "/assets/generated/particles/chimney_smoke.png", movement: "riseWobble", layer: "aboveObjects", radius: 18, visual: "softCircle" },
