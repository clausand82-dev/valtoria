export const POTION_DEFS = {
  ...
  potion_purple_health_mana_50: {
    ...
    type: "hybrid",
    name: "Purple Reinforcement Potion",
    i18n: { da: { name: "Lilla forstærkningsdrik" } },
    rarity: "rare",
  ...
  potion_orange_regen_health_mana: {
    ...
    type: "regen",
    name: "Orange Regeneration Potion",
    i18n: { da: { name: "Orange regenerationsdrik" } },
    rarity: "rare",
    durationMs: 180000,
    tickMs: 1000,
    healthRegenPct: 0.02,
