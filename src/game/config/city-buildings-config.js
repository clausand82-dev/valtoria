...
export const CITY_BUILDINGS = [
  ...
  },
  {
    ...
    title: "Sanctuary",
    prebuilt: true,
    help: "Trains the hero through a warrior skill tree.",
    functionText: "Spend one skill point per level on small combat, survival, scavenging, and discipline upgrades.",
