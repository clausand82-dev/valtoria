...
export function createVillageOutskirtsMapRegions(region) {
  return {  
    ...
    region({
      ...
      foliageSet: [
        { fileName: "foilage/foilage_food.png", weight: 12, scale: 0.5, lootTables: ["material_fruit"], corruption: { max: 4 } },
        { fileName: "foilage/foilage_cityplant.png", weight: 10, lootTables: ["material_plant"], corruption: { max: 4 } },
    ...
    region({
      ...
      foliageSet: [
        { fileName: "foilage/foilage_basement.png", lootTables: ["material_plant", "material_magic_plants"]},
    ...
    region({
      ...
      foliageSet: [
        { fileName: "foilage/foilage_garbage_001.png", scale: 0.75, lootTables: ["material_plant", "material_magic_plants"]},
    ...
    region({
      ...
      labelY: 54,
            foliageSet: [
        { fileName: "foilage/foilage_field.png", weight: 25, blockedBy: {questCompleted: "mayor_repair_village_houses"}, lootTables: ["material_fruit"]},
        { fileName: "foilage/foilage_plants_mainland.png", weight: 10, lootTables: ["material_fruit"]},
        ...
        { fileName: "foilage/foilage_cityplant.png", weight: 25, lootTables: ["material_fruit"]},
      ],
      decay: [
