...
export const RESOURCE_DEFS = {
  ...
  paper: { name: "Paper", i18n: { da: { name: "Papir", description: "Genbrugspapir lavet af gamle noter og boeger." } }, stackMax: 100, value: 2, color: "#f3f4aa", iconUrl: "/assets/generated/item/item_res_paper.png", description: "Recycled paper made from old notes and books." },
  ...
  food: { name: "Food Barrel", i18n: { da: { name: "Madtoende" } }, stackMax: 1000, value: 120, color: "#d49a58", iconUrl: "/assets/generated/item/item_res_food.png" },
  ...
  bonedust: { name: "Bone Dust", i18n: { da: { name: "Benstoev" } }, stackMax: 100, value: 3, color: "#c9c0a6", iconUrl: "/assets/generated/item/item_res_bonedust.png" },
