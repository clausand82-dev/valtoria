...
export const critterMethods = {
  ...
  createAmbientCritter(entry, typeName, entryIndex, localIndex, seedBase) {
    ...
    return {
      ...
      speciesId: entry.speciesId ?? base.speciesId,
      factionId: entry.factionId ?? base.factionId,
      tags: Array.isArray(entry.tags) ? [...entry.tags] : Array.isArray(base.tags) ? [...base.tags] : [],
      x,
      y,
      vx: 0,
      vy: 0,
