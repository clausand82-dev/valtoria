...
export class GameEngine {
  constructor(canvas, onSnapshot, options = {}) {
    ...
    this.isCustomPerformanceProfile = Boolean(options.useCustomPerformanceProfile);
    this.performanceHistory = [];
    this.performanceHistoryMaxSamples = 120;
    this.performanceSampleIntervalMs = 1000;
    this.lastPerformanceSampleTime = 0;
